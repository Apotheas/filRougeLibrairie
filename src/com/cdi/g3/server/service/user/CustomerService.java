package com.cdi.g3.server.service.user;
...
import com.cdi.g3.server.domain.user.User;
import com.cdi.g3.server.domain.user.UserDAO;
...
public final class CustomerService extends AbstractService{
    ...
    // = Business methods =
    // ======================================
    public User createUser( final User user ) throws CreateException, CheckException {
    ...
    public User findUser( final String userId ) throws FinderException, CheckException {
        final String mname = "findUser";
        Trace.entering( _cname, mname, userId );

        checkId( userId );
        // Finds the object
        final User user = (User) _dao.findByPrimaryKey( userId );
        Trace.exiting( _cname, mname, user );
        return user;
    }
    ...
    public void updateUser( final User userDTO  ) throws UpdateException, CheckException {
       ...
       final User user;
        ...
        // Checks if the object exists
        try {
            user = (User) _dao.findByPrimaryKey( userDTO.getId() );
        } catch ( FinderException e ) {
