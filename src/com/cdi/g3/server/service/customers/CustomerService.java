...
//        customerFinded.setEmailCustomer(customer.getEmailCustomer());
//        customerFinded.setNameCompanyCustomer(customer.getNameCompanyCustomer());
//        customerFinded.setStatusCustomer(customer.getStatusCustomer());
//        customerFinded.setCommentCustomer(customer.getCommentCustomer());
